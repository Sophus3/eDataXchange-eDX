...

{
  ...
  "version": 1.0.0,
  "securityGroups": [],
  "displayName": "eDataXchange (eDX) Base Tag",
  ...
  "description": "Template to include the script for the Sophus3 eDataXchange (eDX) service.\n\nwww.sophus3.com",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "Name of the brand of your website in lowercase as confirmed by Sophus3."
  },
  {
    "type": "TEXT",
    "name": "market",
    ...
    "help": "Market of your website in lowercase as confirmed by Sophus3."
  },
  {
    "type": "TEXT",
    "name": "service_id",
    ...
    "simpleValueType": true,
    "help": "Please enter the Service ID provided by Sophus3."
  },
  {
    "type": "CHECKBOX",
    "name": "debugMode",
    "checkboxText": "Enable console log messages.",
    "simpleValueType": true
  }
]
...
Created on 1/14/2025, 11:21:56 AM
